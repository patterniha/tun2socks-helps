...
netsh interface ipv6 set address "wintun" fda0::1/64
...
netsh interface ipv6 set dnsservers name="wintun" static ::1 primary validate=no
netsh interface ipv6 set dnsservers name="Wi-Fi" static ::1 primary validate=no
...
netsh interface ipv6 add route ::/1 "wintun" fda0::1 metric=1
netsh interface ipv6 add route 8000::/1 "wintun" fda0::1 metric=1
